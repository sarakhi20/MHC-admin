...
const AddDoctor = () => {
    ...
    const [speciality, setSpeciality] = useState('Anxiety disorders')
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="Persnolity disorder">Persnolity disorder</option>
                                <option value="Temper tantrum child">Temper tantrum child</option>
